...
<head>
    ...
    <title>{{ $post->title }} — {{ $settings['site_title'] ?? 'Educve LMS' }}</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* DETAILS */
        .post-details { max-width: 800px; margin: 40px auto; padding: 0 24px; line-height: 1.8; }
        .post-header h1 { font-size: 32px; font-weight: 800; margin-bottom: 16px; }
        .post-meta { font-size: 13px; color: var(--muted); margin-bottom: 32px; border-bottom: 1px solid var(--border); padding-bottom: 16px; }
        .post-content { color: var(--text); font-size: 15px; }
    </style>
</head>
<body>
<nav class="navbar">
    ...
    <div>
        <a href="{{ url('/blog') }}" class="btn btn-primary">Blog Home</a>
    </div>
</nav>
